...
<div class="site-container py-20">
  <div class="text-center">
    <p class="section-kicker mb-4">Visit &amp; Order</p>
    <h1 class="display-serif text-6xl font-light">Find Us</h1>
  </div>
</div>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
      <div class="surface-panel p-8 lg:p-10 space-y-6">
        ...
        <div class="border-b border-base-300 pb-5">
          ...
          <p class="display-serif text-2xl">{{ $value }}</p>
        ...
        <div class="flex gap-3 pt-2 flex-wrap">
          ...
          <a href="{{ route('order') }}" class="btn btn-outline tracking-widest text-xs uppercase">Order Online</a>
        </div>
      </div>
      <div class="dish-card overflow-hidden min-h-[440px]">
